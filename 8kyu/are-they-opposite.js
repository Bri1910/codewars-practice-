...
// you can assume that the string only contains letters or it's a empty string. Also take note of the
//  edge case - if both strings are empty then you should return false/False.
